...
resource "aws_lambda_function" "production_lambda" {
  function_name = "production_lambda"
...
resource "aws_api_gateway_resource" "lambda_resource" {
  rest_api_id = aws_api_gateway_rest_api.production_api.id
  parent_id   = aws_api_gateway_rest_api.production_api.root_resource_id
